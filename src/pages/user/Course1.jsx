      ...
      <div className="row">
        <div className="col-4">
          ...
          >
            ...
            <span className="text-white">
              Chapters-16 lessons-106 <br /> fees: 120,000 MMK
            </span>
            ...
            <div className=" d-flex gap-3">
              ...
              <span
                className="text-white bg-purple-600 w-20 text-center rounded-3 p-1"
                style={{ fontSize: "13px" }}
              >
                React
              </span>
        ...
        <div className="col-4">
          ...
          >
            ...
            <div className=" d-flex gap-3">
              <span
                className="text-white bg-yellow-600 w-20 text-center rounded-3 p-1"
                style={{ fontSize: "13px" }}
              >
                JavaScript
              </span>
        ...
        <div className="col-4">
          ...
          >
            ...
            <div className=" d-flex gap-3">
              <span
                className="text-white bg-green-600 w-20 text-center rounded-3 p-1"
                style={{ fontSize: "13px" }}
              >
                JavaScript
              </span>
        ...
        <div className="col-4">
          ...
          >
            ...
            <div className=" d-flex gap-3">
              <span
                className="text-white bg-red-600 w-20 text-center rounded-3 p-1"
                style={{ fontSize: "13px" }}
              >
                JavaScript
              </span>
              <span
                className="text-white bg-purple-800 w-20 text-center rounded-3 p-1"
                style={{ fontSize: "13px" }}
              >
                React
              </span>
